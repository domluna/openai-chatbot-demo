...
def done_generating_response():
    el = PAGE.query_selector("div[class*='PromptTextarea__LastItemActions-sc-4snkpf-3 gRmLdg']")
...
def reset_chat():
    page_elements = PAGE.query_selector_all("a[class*='Navigation__NavMenuItem-sc-rtsy24-0 dWwJhv']")
